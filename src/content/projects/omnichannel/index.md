---
title: "Omnichannel"
description: "Omnichannel, a finance-focused marketplace reconciliation system for Indonesian marketplace sellers"
date: "2026-05-05"
featured: true
...
At first, I thought the main problem was analytics. I wanted to build [Omnichannel](https://omnichannel.entrefine.com/) as a unified marketplace dashboard for business owner or marketplace manager.
...
That is why I started building **[Omnichannel](https://omnichannel.entrefine.com/)** as a finance-focused marketplace reconciliation system.

# The Journey: Finding the Real Product-Market Fit

The first version of the idea was dashboard-driven.

I imagined [Omnichannel](https://omnichannel.entrefine.com/) as a single place where brands can see all marketplace performance. The user can compare Shopee vs TikTok Shop vs Tokopedia, see which channel is growing, see product trend, and understand customer segment.
...
[Omnichannel](https://omnichannel.entrefine.com/) should not only show sales. It should help finance users understand real income, actual payout, every fee deducted from each order, and the real profit after COGS.

# The Vision: A Trusted Finance View for Marketplace Business

[Omnichannel](https://omnichannel.entrefine.com/) is my attempt to turn messy marketplace data into one reliable finance view.

It is not just another dashboard. Under the hood, [Omnichannel](https://omnichannel.entrefine.com/) collects marketplace data, standardize the terms, match orders with settlement and payout data, detect fees and adjustments, and calculate the actual profit.
...
- **Standardized Marketplace Terms**: Shopee, TikTok Shop, Tokopedia, and other marketplaces can have different words for similar things. [Omnichannel](https://omnichannel.entrefine.com/) tries to translate them into one consistent format.
...
- **Fee and Adjustment Detection**: [Omnichannel](https://omnichannel.entrefine.com/) helps identify commission, admin fee, voucher, shipping subsidy, refund, penalty, withholding tax, and other deductions.
...
With [Omnichannel](https://omnichannel.entrefine.com/), I want the experience to feel like having a trusted reconciliation system that can explain where the money goes.
...
That is why building [Omnichannel](https://omnichannel.entrefine.com/) by myself makes sense. The goal is not just integration. The goal is data trust.

# Where I'm At Today

[Omnichannel](https://omnichannel.entrefine.com/) is live and I am continuing to shape it around the real workflow of finance teams.
